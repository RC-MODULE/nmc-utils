...
SILENT_DEP      = @echo '  $(tb_wht)[DEP]$(col_rst)      ' $(@).dep;
SILENT_NMCPP    = @echo '  $(tb_ylw)[NMCPP]$(col_rst)    ' $(@);
SILENT_ASM      = @echo '  $(tb_grn)[ASM]$(col_rst)      ' $(@);
SILENT_LINKER   = @echo '  $(tb_pur)[LINKER]$(col_rst)   ' $(@);
SILENT_LIBRARIAN= @echo '  $(tb_pur)[LIBRARIAN]$(col_rst)' $(@);
SILENT_AR       = @echo '  $(tb_cyn)[AR]$(col_rst)       ' $(@);
SILENT_NMDUMP   = @echo '  $(tb_blu)[NMDUMP]$(col_rst)   ' $(@);
SILENT_IMG      = @echo '  $(tb_cyn)[IMG]$(col_rst)      ' $(@);
SILENT_CLEAN    = @echo '  $(tb_cyn)[CLEAN]$(col_rst)    ' $(@);
endif
